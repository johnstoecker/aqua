                ...
                <div className="row">
                    ...
                    <div id="myCarousel" className="carousel col-sm-6" data-ride="carousel" data-interval="false">
                        ...
                        <div className="onboarding-arrows-container">
                            <a className="onboarding-arrow" href="#" onClick={this.goToPage.bind(this, (this.state.currentPage+2)%3)}>
                                <img src="/public/media/left-arrow.png"/>
                            </a>
                            <a className={"onboarding-arrow " + (this.state.currentPage == 2 && "hidden")} href="#" onClick={this.goToPage.bind(this, (this.state.currentPage+1)%3)}>
