    ...
    render() {
        ...
        return (
            <section className="container">
                ...
                <a href="#" className={"tab-picker " + (this.state.showTab == "lastYear" && "tab-picker-active")} onClick={this.showTab.bind(this, "lastYear")}>Season 7</a>
                </div>
                ...
                <div className="row">
                    ...
                    <div className={"col-sm-8 " + (this.state.showTab=="lastYear" || "hidden")}>
